...
calculate2 = function () {
    var getal1 = document.getElementById('b1').value;
    var getal2 = document.getElementById('b2').value;
    document.getElementById('b3').value = parseInt(getal1) - parseInt(getal2);
